...
export const FacebookIcon = (props: IconProps) => {
  return (
    <span className="flex w-full cursor-pointer items-center justify-center rounded bg-facebook-primary py-[6px] hover:bg-facebook-hover">
      <svg
...
export const GoogleIcon = (props: IconProps) => {
  return (
    <span className="flex w-full cursor-pointer items-center justify-center rounded border-2 border-black/5 bg-google-primary py-[4px] hover:bg-google-hover">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        x="0px"
        y="0px"
...
export const AppleIcon = (props: IconProps) => {
  return (
    <span className="flex w-full cursor-pointer items-center justify-center rounded bg-apple-primary py-[6px] hover:bg-apple-hover">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        x="0px"
        y="0px"
...
export const XboxIcon = (props: IconProps) => {
  return (
    <span className="flex w-full cursor-pointer items-center justify-center rounded bg-xbox-primary py-[6px] hover:bg-xbox-hover">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        x="0px"
        y="0px"
